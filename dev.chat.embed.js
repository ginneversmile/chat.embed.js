(function() {
  ...
  const e =
    '<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/ginneversmile/chat.embed.js@81d39b12a08f2c92e14307d3694748ff26cab621/chat.embed.css"/>' +
    ...
    '       <iframe id="embed_iframe" data-src="https://lonelystar.cf/messenger/embed/customercare@inet.vn?embed&source=' +
  ...
  const messageCount = document.getElementById("embed_iframe");
  const counter = document.getElementById("counter");
  messageCount.style.cssText = "width: 400px; height: 450px;";
  ...
  const iframeWin = messageCount.contentWindow;
